      ...
      <AnimatePresence>
        {needRefresh && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0, x: '-50%', scale: 1 }}
            exit={{ opacity: 0, y: -20, x: '-50%', scale: 0.9 }}
            className="fixed top-6 left-1/2 -translate-x-1/2 z-50 bg-[#140b05]/95 border border-brand-gold/30 text-[#fdfaf6] px-5 py-4 rounded-2xl shadow-[0_15px_40px_rgba(0,0,0,0.8)] font-sans text-sm flex flex-col items-center gap-3 backdrop-blur-md w-[90%] max-w-sm"
          >
            <div className="text-center">
              ...
              <p className="text-xs text-[#fdfaf6]/80 leading-relaxed">
                Refresh now to experience the latest designs and improvements!
              </p>
            </div>
